...
import com.example.android.glass.glassdesign.fragments.LyoLayoutFragment;
        ...
        if (requestCode == REQUEST_CODE && resultCode == RESULT_OK && data != null) {
            ...
            switch (id) {
                case R.id.bVideoCall2:
                    ...
                    break;
                case R.id.bAgora2:
                    Intent intent1 = new Intent(this.getApplicationContext(), AgoraActivity.class);
                    intent1.putExtra("ChannelName", "Sample");
