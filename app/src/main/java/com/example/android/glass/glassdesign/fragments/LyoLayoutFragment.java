...
public class LyoLayoutFragment extends BaseFragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null){
            ...
            switch (type){
                case "normal":
                    ivIcon.setImageResource(R.drawable.baseline_input_24);
               ...
               //     tvStep.setBackgroundColor(getResources().getColor(R.color.color_green_light));
                ...
                case "critical":
                    ivIcon.setImageResource(R.drawable.baseline_report_problem_24);
                    ivAction.setImageResource(R.drawable.baseline_touch_app_24);
               //     tvStep.setBackgroundColor(getResources().getColor(R.color.color_red_light));

                    break;

                case "camera":
                    ivIcon.setImageResource(R.drawable.outline_camera_alt_24);
                    ivAction.setImageResource(R.drawable.baseline_swipe_24);
                    //    tvStep.setBackgroundColor(getResources().getColor(R.color.color_yellow_light));
                    break;

                case "info":
                    ivIcon.setImageResource(R.drawable.baseline_info_24);
                    ivAction.setImageResource(R.drawable.baseline_swipe_24);
